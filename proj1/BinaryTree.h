...
int num_null_leaves(BinaryNode *);
int get_tree_height(BinaryNode *);
TreeItem return_rightmost(BinaryNode *);
void copy_helper(BinaryNode *&, BinaryNode *&);
double get_tree_sum(BinaryNode *, int);
...
public:
    ...
    // Binary Tree information functions
    bool is_full() const;
    bool is_empty() const;
